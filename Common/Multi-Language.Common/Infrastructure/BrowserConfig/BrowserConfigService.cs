...
namespace Multi_language.Common.Infrastructure.BrowserConfig
{
    public class BrowserConfigService : IBrowserConfigService
    {
        private readonly System.Web.Mvc.UrlHelper urlHelper = new UrlHelper();
        ...
        private string GetTileUrl(int feedEntry)
        {
            ...
            return string.Format(
                ...
                this.urlHelper.AbsoluteRouteUrl("GetFeed"),
                feedEntry);
        }
    }
}